"""SE PONEN EN MINUSTUCLA LOS NOMBRES DE LAS TALBLAS PORQUE QUIZA SEA ESE EL ERROR

Revision ID: e4f5e7cee872
Revises: 
Create Date: 2025-06-19 17:40:48.440527
...
def upgrade() -> None:
    ...
    sa.Column('ategoria_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['asociacion_id'], ['test_schema.asociacion.id'], ),
    sa.ForeignKeyConstraint(['ategoria_id'], ['test_schema.categoria.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='test_schema'
    )
